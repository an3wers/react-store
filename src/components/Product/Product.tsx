      ...
      <div className='px-5 pb-5 space-y-4'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <button
            ...
            className='text-white bg-blue-700 border border-transparent hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2 text-center disabled:opacity-50'
          >
