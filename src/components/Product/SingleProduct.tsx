...
const SingleProduct: React.FC<ISingleProductProps> = ({ item }) => {
    ...
    const isInCart = useMemo(() => {
      ...
      const addCartHandler = () => {
        addItem({ id: item.id, title: item.title, price: item.price, count: 1, image: item.image })
      }
        ...
        <div className="grid grid-cols-12 gap-6 py-6">
            ...
            <div className=" col-span-12 col-start-1 col-end-13 md:col-span-6 md:col-start-7 md:col-end-13 xl:col-start-7 xl:col-end-12 xl:col-span-5">
                <div className=" flex flex-col space-y-6">
                    ...
                    <div className=" text-xl font-bold">{useFormatterPrice(item.price)}</div>
                    {/* Проверка, есть ли в корзине */}
                    <button disabled={isInCart} onClick={addCartHandler} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 mr-2 mb-2 focus:outline-none disabled:opacity-50">
